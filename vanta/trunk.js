...
import P5Base, { VANTA } from "../node_modules/vanta/src/_p5Base.js";
import { color2Hex, mobileCheck } from "../node_modules/vanta/src/helpers.js";
...
class Effect extends P5Base {
  ...
  onInit() {
    ...
    let sketch = function (p) {
      ...
      let rings = 20;
      let dim_init = 0; // how big the first ring is
      let dim_delta = 3; // how much each ring grows
